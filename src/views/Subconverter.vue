...
const defaultBackend = "https://sub.dokploy.pp.ua"
const shortUrlBackend = "https://sub.dokploy.pp.ua/short"
  ...
  data() {
    return {
      ...
      options: {
        ...
        shortTypes: {
          "v1.mk": "https://sub.dokploy.pp.ua/short",
        ...
        customBackend: {
          "肥羊增强型后端【vless reality+hy1+hy2】": "https://sub.dokploy.pp.ua",
        ...
        remoteConfig: [
          {
            ...
            options: [
              {
                label: "默认(自用)",
                value: "https://raw.githubusercontent.com/ruich-4/mihomo/heads/main/default.ini"
              },
              {
                label: "默认",
      ...
      form: {
        ...
        remoteConfig: "https://raw.githubusercontent.com/ruich-4/mihomo/heads/main/default.ini",
        excludeRemarks: "",
        includeRemarks: "",
        filename: "",
        rename: "",
